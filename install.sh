...
# ── Hyprland ──
HYPRLAND_PKGS=(hyprland hyprlock hypridle waybar rofi swaybg swaync wl-clipboard cliphist polkit-kde-agent blueman udiskie brightnessctl playerctl wireplumber grim slurp jq btop ttf-firacode-nerd)
...
if [ "$HAS_HYPRLAND" = true ]; then
  ...
  backup_and_link ~/.config/hypr/hypridle-desktop.conf "$DOTFILES/other/hypr/hypridle-desktop.conf"
  backup_and_link ~/.config/hypr/hypridle-laptop.conf "$DOTFILES/other/hypr/hypridle-laptop.conf"
